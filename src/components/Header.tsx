...
const ecosystemDomains = [
  ...
  { name: 'IoMarkets.ai', subtitle: 'AI-Powered Markets Intelligence', url: 'https://iomarkets.ai', icon: 'ðŸ¤–', current: true },
          ...
          <nav className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-cyan-400 -mt-0.5 uppercase tracking-wider font-bold">AI INTELLIGENCE</span>
              </div>
            </Link>
